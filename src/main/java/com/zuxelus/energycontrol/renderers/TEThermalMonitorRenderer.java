...
public class TEThermalMonitorRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntityThermalMonitor te, double x, double y, double z) {
        ...
        func_147498_b().drawString(
            ...
            -func_147498_b().getStringWidth(String.valueOf(value)) / 2,
            -func_147498_b().FONT_HEIGHT,
            0x000000);
        GL11.glPopMatrix();
    }
