...
public class DriverAdvancedInfoPanel extends DriverSidedTileEntity {
    ...
    public static final class Environment extends ManagedTileEntityEnvironment<TileEntityAdvancedInfoPanel>
        ...
        public Object[] setColorBack(final Context context, final Arguments args) {
            ...
            if (newColor >= 0 && newColor < 16) tileEntity.setColorBackground(newColor);
            return null;
        }
