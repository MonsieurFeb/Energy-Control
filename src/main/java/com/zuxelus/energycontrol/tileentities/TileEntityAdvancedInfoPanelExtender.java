...
public class TileEntityAdvancedInfoPanelExtender extends TileEntityInfoPanelExtender {
    ...
    public byte getThickness() {
        if (screen == null) return 16;
        TileEntityInfoPanel core = screen.getCore(worldObj);
        if (!(core instanceof TileEntityAdvancedInfoPanel)) return 16;
    ...
    public byte getRotateHor() {
        ...
        TileEntityInfoPanel core = screen.getCore(worldObj);
        if (!(core instanceof TileEntityAdvancedInfoPanel)) return 0;
    ...
    public ForgeDirection getRotation() {
        if (screen == null) return ForgeDirection.NORTH;
        TileEntityInfoPanel core = screen.getCore(worldObj);
        if (!(core instanceof TileEntityAdvancedInfoPanel)) return ForgeDirection.NORTH;
