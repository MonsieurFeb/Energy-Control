...
public class TileEntityInfoPanelRenderer extends TileEntitySpecialRenderer {
    ...
    public static void renderText(List<PanelString> joinedData, float displayWidth, float displayHeight, int colorHex,
        ...
        for (PanelString panelString : joinedData) {
            ...
            if (panelString.textRight != null) fontRenderer.drawString(
