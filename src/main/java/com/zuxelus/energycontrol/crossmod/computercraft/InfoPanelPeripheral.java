...
public class InfoPanelPeripheral implements IPeripheral {
    ...
    public String[] getMethodNames() {
        return new String[] { "hasColorUpgrade", "isActive", "getRange", "getCardData", "getCardDataRaw",
            "getColorBack", "getColorText", "setColorBack", "setColorText", "getCardTitle", "setCardTitle" };
    }
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] args) {
        ...
        switch (method) {
            ...
            case 10:
                ...
                stack = te.getStackInSlot(0);
                if (title != null && ItemCardMain.isCard(stack)) new ItemCardReader(stack).setTitle(title);
                return null;
        }
        return null;
    }
