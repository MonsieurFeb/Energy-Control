...
public class ItemKitGalacticraft extends ItemKitBase {
    ...
    public ItemStack getSensorCard(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side) {
        ...
        if (te instanceof TileEntityOxygenCollector || te instanceof TileEntityOxygenSealer
            || te instanceof TileEntityOxygenDetector
            || te instanceof TileEntityRefinery
            || te instanceof TileEntityElectrolyzer
            || te instanceof TileEntityMethaneSynthesizer
            || te instanceof TileEntityGasLiquefier
            || te instanceof TileEntityOxygenStorageModule
            || te instanceof TileEntityEnergyStorageModule
            || te instanceof TileEntitySolar
