...
public class CubeRenderer {
    ...
    public CubeRenderer(float offX, float offY, float offZ, int width, int height, int depth, float textureWidth,
        float textureHeight, int faceOffsetX, int faceOffsetY) {
        this(
            offX,
            offY,
            offZ,
    ...
    public CubeRenderer(float x, float y, float z, int dx, int dy, int dz, float textureWidth, float textureHeight,
        int faceTexU, int faceTexV, RotationOffset offset) {
        cube = new CubeBox(
            x,
            y,
            z,
    ...
    private static class CubeBox {
        ...
        public CubeBox(float x, float y, float z, int dx, int dy, int dz, float textureWidth, float textureHeight,
            ...
            quadList[0] = new TexturedQuad(
                new PositionTextureVertex[] { v4, v, v1, v5 },
                dz + dx,
                dz,
                dz + dx + dz,
                dz + dy,
            ...
            quadList[1] = new TexturedQuad(
                new PositionTextureVertex[] { v7, v3, v6, v2 },
                0,
                dz,
                dz,
                dz + dy,
            ...
            quadList[2] = new TexturedQuad(
                new PositionTextureVertex[] { v4, v3, v7, v },
                dz,
                0,
                dz + dx,
                dz,
            ...
            quadList[3] = new TexturedQuad(
                new PositionTextureVertex[] { v1, v2, v6, v5 },
                faceTexU + dz + dx,
                faceTexV + dz,
                faceTexU + dz + dx + dx,
                faceTexV,
            ...
            quadList[4] = new TexturedQuad(
                new PositionTextureVertex[] { v, v7, v2, v1 },
                dz,
                dz,
                dz + dx,
                dz + dy,
            ...
            quadList[5] = new TexturedQuad(
                new PositionTextureVertex[] { v3, v4, v5, v6 },
                dz + dx + dz,
                dz,
                dz + dx + dz + dx,
                dz + dy,
