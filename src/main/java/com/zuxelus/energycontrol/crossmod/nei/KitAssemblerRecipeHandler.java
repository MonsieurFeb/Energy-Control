...
public class KitAssemblerRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        for (KitAssemblerRecipe recipe : KitAssemblerRecipe.getRecipes())
            if (recipe.input1.getItem() == ingredient.getItem() || recipe.input2.getItem() == ingredient.getItem()
                || recipe.input3.getItem() == ingredient.getItem())
                arecipes.add(new CachedKitAssemblerRecipe(recipe.input1, recipe.input2, recipe.input3, recipe.output));
    }
    ...
    public void loadTransferRects() {
        transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(81, 24, 25, 16), getRecipeId(), new Object[0]));
    }
