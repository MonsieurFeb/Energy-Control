...
public class ContainerAverageCounter extends ContainerBase<TileEntityAverageCounter> {
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) if (lastAverage != average) NetworkHelper
            .updateClientTileEntity((ICrafting) crafters.get(i), te.xCoord, te.yCoord, te.zCoord, 1, average);
        lastAverage = average;
    }
