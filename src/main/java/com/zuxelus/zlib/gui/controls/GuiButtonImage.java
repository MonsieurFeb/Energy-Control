...
public class GuiButtonImage extends GuiButton {
    ...
    public GuiButtonImage(int id, int left, int top, int width, int height, int xTexStart, int yTexStart, int yDiffText,
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        if (displayString != "") {
            ...
            fontRenderer.drawString(
                ...
                enabled ? hovered ? hoverColor : color : -0x5F5F60);
        }
    }
