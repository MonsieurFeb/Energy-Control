...
public class ContainerSeedAnalyzer extends ContainerBase<TileEntitySeedAnalyzer> {
    ...
    public ContainerSeedAnalyzer(EntityPlayer player, TileEntitySeedAnalyzer te) {
        ...
        addSlotToContainer(
            new SlotDischargeable(te, TileEntitySeedAnalyzer.SLOT_DISCHARGER, 56, 53, TileEntitySeedAnalyzer.TIER));
        // inventory
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) if (lastEnergy != energy || lastProduction != production) {
