...
import com.zuxelus.energycontrol.items.ItemBase;
...
public class ModItems {
    ...
    public static void registerTileEntities() {
        ...
        GameRegistry
            .registerTileEntity(TileEntityInfoPanel.class, EnergyControl.MODID + ":" + TileEntityInfoPanel.NAME);
        GameRegistry
            .registerTileEntity(TileEntityInfoPanelExtender.class, EnergyControl.MODID + ":info_panel_extender");
        GameRegistry.registerTileEntity(
            TileEntityAdvancedInfoPanel.class,
            EnergyControl.MODID + ":" + TileEntityAdvancedInfoPanel.NAME);
        GameRegistry.registerTileEntity(
            TileEntityAdvancedInfoPanelExtender.class,
            EnergyControl.MODID + ":info_panel_advanced_extender");
        GameRegistry.registerTileEntity(TileEntityHoloPanel.class, EnergyControl.MODID + ":holo_panel");
        GameRegistry
            .registerTileEntity(TileEntityHoloPanelExtender.class, EnergyControl.MODID + ":holo_panel_extender");
