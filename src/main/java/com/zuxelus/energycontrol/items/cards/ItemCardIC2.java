...
public class ItemCardIC2 extends ItemCardBase {
    ...
    public CardState update(World world, ICardReader reader, int range, int x, int y, int z) {
        ...
        NBTTagCompound tag = CrossModLoader.getCrossMod(ModIDs.IC2)
            .getCardData(te);
    ...
    public List<PanelString> getStringData(int settings, ICardReader reader, boolean isServer, boolean showLabels) {
        ...
        if (reader.hasField(DataHelper.HEAT) && (settings & 1) > 0) addHeat(
            result,
            "msg.ec.InfoPanelTemp",
            reader.getInt(DataHelper.HEAT),
            reader.getInt(DataHelper.MAXHEAT),
            showLabels);
        ...
        if (reader.hasField(DataHelper.MAXHEAT) && (settings & 1) > 0) result
            .add(new PanelString("msg.ec.InfoPanelMelting", reader.getInt(DataHelper.MAXHEAT) * 85 / 100, showLabels));
        ...
        if (reader.hasField(DataHelper.ENERGYHU) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelEnergy", reader.getLong(DataHelper.ENERGYHU), "HU", showLabels));
        if (reader.hasField(DataHelper.ENERGYKU) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelEnergy", reader.getLong(DataHelper.ENERGYKU), "KU", showLabels));
        if (reader.hasField(DataHelper.CAPACITY) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelCapacity", reader.getLong(DataHelper.CAPACITY), "EU", showLabels));
        if (reader.hasField(DataHelper.CAPACITYHU) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelCapacity", reader.getLong(DataHelper.CAPACITYHU), "HU", showLabels));
        if (reader.hasField(DataHelper.CAPACITYKU) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelCapacity", reader.getLong(DataHelper.CAPACITYKU), "KU", showLabels));
        if (reader.hasField(DataHelper.DIFF) && (settings & 2) > 0) result
            .add(new PanelString("msg.ec.InfoPanelDifference", reader.getDouble(DataHelper.DIFF), "EU/t", showLabels));
        if (reader.hasField(DataHelper.CONSUMPTION) && (settings & 4) > 0) result.add(
            new PanelString(
                "msg.ec.InfoPanelConsumption",
                reader.getDouble(DataHelper.CONSUMPTION),
                "mB/t",
                showLabels));
        if (reader.hasField(DataHelper.OUTPUT) && (settings & 4) > 0) result
            .add(new PanelString("msg.ec.InfoPanelOutput", reader.getDouble(DataHelper.OUTPUT), "EU/t", showLabels));
        if (reader.hasField(DataHelper.OUTPUTHU) && (settings & 4) > 0) result
            .add(new PanelString("msg.ec.InfoPanelOutput", reader.getDouble(DataHelper.OUTPUTHU), "HU/t", showLabels));
        if (reader.hasField(DataHelper.OUTPUTKU) && (settings & 4) > 0) result
            .add(new PanelString("msg.ec.InfoPanelOutput", reader.getDouble(DataHelper.OUTPUTKU), "KU/t", showLabels));
        if (reader.hasField(DataHelper.OUTPUTMB) && (settings & 4) > 0) result
            .add(new PanelString("msg.ec.InfoPanelOutput", reader.getDouble(DataHelper.OUTPUTMB), "mB/t", showLabels));
        if (reader.hasField(DataHelper.MULTIPLIER) && (settings & 8) > 0) result
            .add(new PanelString("msg.ec.InfoPanelMultiplier", reader.getDouble(DataHelper.MULTIPLIER), showLabels));
        ...
        if (reader.hasField("calcification") && (settings & 64) > 0) result.add(
            new PanelString(
                "ic2.SteamGenerator.gui.calcification",
                reader.getDouble("calcification"),
                "%",
                showLabels));
