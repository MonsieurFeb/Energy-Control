...
public class ContainerSeedLibrary extends ContainerBase<TileEntitySeedLibrary> {
    ...
    public ContainerSeedLibrary(EntityPlayer player, TileEntitySeedLibrary te) {
        ...
        addSlotToContainer(
            new SlotDischargeable(te, TileEntitySeedLibrary.SLOT_DISCHARGER, 8, 110, TileEntitySeedLibrary.TIER));
        for (int i = 1; i < 9; i++) addSlotToContainer(new SlotFilter(te, i, 8 + i * 18, 110));
