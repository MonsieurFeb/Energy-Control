...
public class ItemCardEnderIO extends ItemCardBase {
    ...
    public CardState update(World world, ICardReader reader, int range, int x, int y, int z) {
        ...
        NBTTagCompound tag = CrossModLoader.getCrossMod(ModIDs.ENDER_IO)
            .getCardData(te);
    ...
    public List<PanelString> getStringData(int settings, ICardReader reader, boolean isServer, boolean showLabels) {
         ...
         * result.add(new PanelString("msg.ec.InfoPanelLeakage", reader.getDouble("leakage"), euType + "/t",
         * showLabels));
         ...
         * result.add(new PanelString("msg.ec.InfoPanelMaxInput", reader.getDouble("maxInput"), euType + "/t",
         * showLabels));
         * if (reader.hasField("maxOutput") && (settings & 32) > 0)
         * result.add(new PanelString("msg.ec.InfoPanelMaxOutput", reader.getDouble("maxOutput"), euType + "/t",
         * showLabels));
         * if (reader.hasField("difference") && (settings & 32) > 0)
         * result.add(new PanelString("msg.ec.InfoPanelDifference", reader.getDouble("difference"), euType + "/t",
         * showLabels));
