...
public class AdvancedInfoPanelPeripheral implements IPeripheral {
    ...
    public String[] getMethodNames() {
        return new String[] { "isActive", "getRange", "getCardData", "getCardDataRaw", "getColorBack", "getColorText",
            "setColorBack", "setColorText", "getCardTitle", "setCardTitle", "getThickness", "setThickness", "getRotHor",
        ...
        switch (method) {
            ...
            case 1:
                ...
                if (itemStack != null && itemStack.getItem() instanceof ItemUpgrade
                    && itemStack.getItemDamage() == ItemUpgrade.DAMAGE_RANGE) upgradeCountRange = itemStack.stackSize;
            ...
            case 6:
                ...
                if (value >= 0 && value < 16) te.setColorBackground(value);
                return null;
            case 7:
                value = ArgumentHelper.getInt(args, 0);
                if (value >= 0 && value < 16) te.setColorText(value);
                return null;
            case 8:
                value = ArgumentHelper.getInt(args, 0);
                if (value < 0 || value > 2) return new Object[] { "" };
                stack = te.getStackInSlot(value);
                if (!ItemCardMain.isCard(stack)) return new Object[] { "" };
            ...
            case 9:
                ...
                stack = te.getStackInSlot(value);
                if (ItemCardMain.isCard(stack)) new ItemCardReader(stack).setTitle(title);
                return null;
            case 10:
