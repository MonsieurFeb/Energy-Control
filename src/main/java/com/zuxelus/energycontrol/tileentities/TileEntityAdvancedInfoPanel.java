...
public class TileEntityAdvancedInfoPanel extends TileEntityInfoPanel {
    ...
    public void setPowerMode(byte mode) {
        powerMode = mode;
        if (worldObj != null && !worldObj.isRemote) updateBlockState();
    }
    ...
    protected void readProperties(NBTTagCompound tag) {
        ...
        if (tag.hasKey("powerMode")) setPowerMode(tag.getByte("powerMode"));
        if (tag.hasKey("thickness")) thickness = tag.getByte("thickness");
        if (tag.hasKey("rotateHor")) rotateHor = tag.getByte("rotateHor");
        if (tag.hasKey("rotateVert")) rotateVert = tag.getByte("rotateVert");
    }
