...
public class CrossEnderIO extends CrossModBase {
    ...
    public ArrayList getHookValues(TileEntity te) {
        ...
        if (values == null) EnderIOHooks.map.put(te, null);
        return values;
    }
    ...
    public void loadRecipes() {
        Recipes.addShapedRecipe(
            ModItems.itemKit,
            ItemCardType.KIT_ENDER_IO,
            new Object[] { "IT", "PD", 'P', Items.paper, 'D', "dyePink", 'T',
                new ItemStack(ModItems.itemComponent, 1, ItemComponent.RADIO_TRANSMITTER), 'I', "itemSilicon" });
