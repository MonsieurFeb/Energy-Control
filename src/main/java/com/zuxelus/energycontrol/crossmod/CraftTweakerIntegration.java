...
public class CraftTweakerIntegration {
    ...
    public static class KitAssemblerHandler {
        ...
        @ZenMethod
        public static void addRecipe(IItemStack input1, IItemStack input2, IItemStack input3, IItemStack output,
            int time) {
            KitAssemblerRecipe.addRecipe(
                new KitAssemblerRecipe(getStack(input1), getStack(input2), getStack(input3), getStack(output), time));
        }
