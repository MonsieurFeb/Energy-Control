...
public class ContainerEnergyCounter extends ContainerBase<TileEntityEnergyCounter> {
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); i++) if (lastCounter != counter) NetworkHelper
            .updateClientTileEntity((ICrafting) crafters.get(i), te.xCoord, te.yCoord, te.zCoord, 1, counter);
        lastCounter = counter;
    }
