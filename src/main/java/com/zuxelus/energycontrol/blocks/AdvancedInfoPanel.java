...
public class AdvancedInfoPanel extends InfoPanel {
    ...
    public float[] getBlockBounds(TileEntityFacing tile) {
        if (!(tile instanceof TileEntityAdvancedInfoPanel)) return super.getBlockBounds(tile);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int facing, float hitX,
        ...
        if (!world.isRemote) player.openGui(EnergyControl.instance, BlockDamages.DAMAGE_ADVANCED_PANEL, world, x, y, z);
        return true;
    }
}
